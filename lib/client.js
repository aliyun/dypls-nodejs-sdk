...
var msgTypeList = ["SecretReport", "SmsUp"];
...
var SMSClient = function () {
  ...
  (0, _createClass3.default)(SMSClient, [{
    ...
    key: 'receiveMsg',
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(preQueueName) {
        var waitSeconds = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
        var mnsClient;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this._getMNSClient(0);

              case 2:
                mnsClient = _context2.sent;
                _context2.next = 5;
                return mnsClient.receiveMessage(preQueueName + msgTypeList[0], waitSeconds);
